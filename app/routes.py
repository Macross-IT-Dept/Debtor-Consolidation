...
from app import app
from .controllers import index, dashboard_page, contacts_data, contactgroups_data, user_page, user_edit_page, login_page, logout_page, account_edit_page, users_data, users_create, users_delete, redirect_statement, statement_page, statement_data, history_page, history_data
from .XeroController import XeroContactRequests, XeroInvoiceRequests, XeroDownloadInvoice, XeroContactGroupRequests
...
api_bp.add_url_rule('/contactgroups', view_func=contactgroups_data, methods=['GET'], endpoint='contactgroups')
...
api_bp.add_url_rule('/xero/contactgroups', view_func=XeroContactGroupRequests, methods=['GET'], endpoint='Xero_ContactGroups')
