...
from app import app
from .controllers import index, dashboard_page, contacts_data, user_page, login_page, logout_page, users_data, users_create, users_delete, redirect_statement, statement_page, statement_data, history_page, history_data
...
app.add_url_rule('/user', view_func=user_page, methods=['GET', 'POST'], endpoint='user_page')
